-- ============================================================
-- Q12.sql  (ΔΙΟΡΘΩΜΕΝΟ)
-- Απαιτούμενο προσωπικό ανά τμήμα, βάρδια και υποκλάση για συγκεκριμένη εβδομάδα
-- ΔΙΟΡΘΩΣΗ 1: GROUP BY χρησιμοποιεί expressions αντί alias (strict MariaDB)
-- ΔΙΟΡΘΩΣΗ 2: CASE αντί COALESCE για ασφαλέστερο NULL handling ανά staff_type
-- ============================================================
SELECT
